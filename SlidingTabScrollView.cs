...
namespace iAppAndroid
{
    public class SlidingTabScrollView : HorizontalScrollView
    {
        ...
        private const int TAB_VIEW_TEXT_SIZE_SP = 16;
        ...
        public SlidingTabScrollView(Context context, IAttributeSet attrs, int defaultStyle) : base(context, attrs, defaultStyle)
        {
            ...
            FillViewport = true;
            this.SetBackgroundColor(Android.Graphics.Color.Rgb(0xfa, 0xfa, 0xfa)); // orange color
        ...
        private void PopulateTabStrip()
        {
            ...
            for (int i = 0; i < adapter.Count; i++)
            {
                ...
                tabView.Text = ((SlidingTabsFragment.ListInsidePagerAdapter)adapter).GetHeaderTitle(i);
